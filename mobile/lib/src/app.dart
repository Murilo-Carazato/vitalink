      ...
      builder: (BuildContext context, Widget? child) {
        return MaterialApp(
          ...
          theme: ThemeData(
            ...
            textTheme: const TextTheme(
              ...
              labelMedium: TextStyle(
                  fontFamily: 'Inter',
                  color: Color.fromRGBO(51, 49, 56, 1),
                  fontWeight: FontWeight.normal,
                  fontSize: 16),
            ...
            textButtonTheme: TextButtonThemeData(
              style: ButtonStyle(
                ...
                overlayColor: const WidgetStatePropertyAll(
                    Color.fromRGBO(255, 38, 14, 1)),
                shadowColor: const WidgetStatePropertyAll(
                    Color.fromRGBO(172, 169, 169, 1)),
              ),
            ),
            ...
            dropdownMenuTheme: DropdownMenuThemeData(
              menuStyle: MenuStyle(
                ...
                fixedSize: WidgetStatePropertyAll(
                    Size(MediaQuery.sizeOf(context).width / 3, 120)),
              ),
              ...
              inputDecorationTheme: const InputDecorationTheme(
                ...
                focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(10)),
                    borderSide:
                        BorderSide(color: Color(0xFFF7887C), width: 1.2)),
                enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(10)),
                    borderSide: BorderSide(color: Styles.border, width: 1.2)),
                errorBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.all(Radius.circular(10)),
                    borderSide: BorderSide(color: Styles.primary, width: 1.2)),
            ...
            datePickerTheme: DatePickerThemeData(
              ...
              cancelButtonStyle: ButtonStyle(
                ...
                maximumSize: WidgetStatePropertyAll(
                    Size(MediaQuery.sizeOf(context).width / 2.5, 40)),
                backgroundColor: const WidgetStatePropertyAll(Colors.white),
                side: const WidgetStatePropertyAll(
                    BorderSide(color: Styles.border)),
            ...
            textSelectionTheme: const TextSelectionThemeData(
                ...
                selectionColor: Color.fromRGBO(237, 28, 36, 0.2),
            ...
            inputDecorationTheme: const InputDecorationTheme(
              ...
              focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                  borderSide: BorderSide(color: Color(0xFFF7887C), width: 1.2)),
              enabledBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                  borderSide: BorderSide(color: Styles.border, width: 1.2)),
              errorBorder: OutlineInputBorder(
          ...
          darkTheme: ThemeData(
            ...
            //appBar
            appBarTheme:
                const AppBarTheme(backgroundColor: Styles.darkBackground),
            ...
            textTheme: const TextTheme(
              ...
              labelMedium: TextStyle(
                  fontFamily: 'Inter',
                  color: Color.fromRGBO(231, 230, 233, 1),
                  fontWeight: FontWeight.normal,
                  fontSize: 16),
              labelSmall: TextStyle(
                  fontFamily: 'Inter',
                  color: Color.fromRGBO(203, 203, 204, 1),
                  fontWeight: FontWeight.w600,
                  fontSize: 14),
              headlineMedium: TextStyle(
                  fontFamily: 'Inter',
            ...
            inputDecorationTheme: const InputDecorationTheme(
              ...
              focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                      color: Color.fromARGB(255, 145, 32, 20), width: 1.2)),
              enabledBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                  borderSide: BorderSide(color: Styles.gray2, width: 1.2)),
              errorBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                  borderSide: BorderSide(color: Styles.primary, width: 1.2)),
              errorStyle: TextStyle(
            ...
            datePickerTheme: DatePickerThemeData(
              ...
              cancelButtonStyle: ButtonStyle(
                ...
                maximumSize: WidgetStatePropertyAll(
                    Size(MediaQuery.sizeOf(context).width / 2.5, 40)),
                backgroundColor:
                    const WidgetStatePropertyAll(Color(0xFF222225)),
                side: const WidgetStatePropertyAll(
                    BorderSide(color: Styles.gray1)),
                foregroundColor:
                    const WidgetStatePropertyAll(Color(0xFFB2B3BD)),
            ...
            dropdownMenuTheme: DropdownMenuThemeData(
              menuStyle: MenuStyle(
                elevation: const WidgetStatePropertyAll(2),
                backgroundColor:
                    const WidgetStatePropertyAll(Styles.darkBorder),
                shape: const WidgetStatePropertyAll(RoundedRectangleBorder(
                    borderRadius: BorderRadius.all(Radius.circular(12)))),
                fixedSize: WidgetStatePropertyAll(
                    Size(MediaQuery.sizeOf(context).width / 3, 120)),
            ...
            //divider
            dividerTheme:
                const DividerThemeData(color: Color.fromARGB(255, 56, 53, 53)),
            ...
            elevatedButtonTheme: const ElevatedButtonThemeData(
              style: ButtonStyle(
                side: WidgetStatePropertyAll(
                    BorderSide(color: Color(0xFF3E3F44))),
                backgroundColor: WidgetStatePropertyAll(Styles.darkBackground),
                foregroundColor:
                    WidgetStatePropertyAll(Color.fromARGB(255, 238, 238, 238)),
                minimumSize: WidgetStatePropertyAll(Size(20, 30)),
                textStyle: WidgetStatePropertyAll(
                  //bodyMedium
                  TextStyle(
...
class _MyTabState extends State<MyTab> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> names = [
      ...
      MySearchBar(
          controller: searchController, bloodCenterStore: bloodCenterStore),
